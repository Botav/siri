...
#==============================================================================#
#==============================================================================#
line = LINE('ajasarehun@gmail.com', 'ehun4321')
#line = LINE('') #Token
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki = LINE('ehunaja18@gmail.com', 'ehun4321')
#ki = LINE('') #Token
...
#==============================================================================#
                ...
                elif text.lower() == 'help sos':
                    socMedia = socmedia()
                    line.sendMessage(to, str(socMedia))
                elif text.lower() == 'help spic':
                    helpTextToSpeech = helptexttospeech()
                    line.sendMessage(to, str(helpTextToSpeech))
                elif text.lower() == 'help bahasa':
...
#==============================================================================#
                    ...
                    msg.text = None
                    line.sendMessage(msg)
                elif "Spm "in msg.text.lower():
                    red = re.compile(re.escape('Spm '),re.IGNORECASE)
...
#==============================================================================#
                ...
                elif msg.text.lower().startswith("an "):
                ...
                elif msg.text.lower().startswith("in "):
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                ...
                elif msg.text.lower().startswith("un "):
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                ...
                elif msg.text.lower().startswith("bn "):
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
